...
python bert_exploration.py --objective cls --exp-type same --exp-name simec-bert-cls --model-name ctoraman/hate-speech-bert --out-dir ../res/ --txt-dir ../hate_explain/generated --iter 1000 --save-each 10
python bert_exploration.py --objective cls --exp-type diff --exp-name simexp-bert-cls --model-name ctoraman/hate-speech-bert --out-dir ../res/ --txt-dir ../hate_explain/generated --iter 1000 --save-each 10

echo "BERT MSK Exploration ..."
python bert_exploration.py --objective mask --exp-type same --exp-name simec-bert-msk --model-name bert-base-uncased --out-dir ../res/ --txt-dir ../mlm_data/generated --iter 1000 --save-each 10
