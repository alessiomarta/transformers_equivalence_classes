...
python3 text_convert.py --dataset uclanlp/wino_bias --subset type1_pro --xlabel tokens --mask coreference_clusters --explore coreference_clusters --model-path bert-base-uncased --sample 50